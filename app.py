...
st.markdown("""
    ...
    .header-title { color: #00d4ff !important; font-weight: 800; letter-spacing: 5px; font-size: 2.2em; }
...
st.markdown("""
    <div class="header-container">
        <div class="header-sub">INTELLIGENCE MONITORING SYSTEM v4.0</div>
            ...
            <div class="ai-monitor-wrapper">
                <div class="ai-monitor-box">
                    ...
                    <div style="color:#00d4ff; line-height:1.6;">
                        ...
                        分析摘要：本期數據顯示資策會在媒體端的討論熱度集中於數位人才與認證機制，市場反饋正面。
                    </div>
                </div>
            </div>
            """, unsafe_allow_html=True)
